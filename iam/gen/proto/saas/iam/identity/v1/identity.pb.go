...
const file_saas_iam_identity_v1_identity_proto_rawDesc = "" +
	"\n" +
	"#saas/iam/identity/v1/identity.proto\x12\x14saas.iam.identity.v1\x1a\x1bbuf/validate/validate.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xf3\x03\n" +
	"\x04User\x12\x17\n" +
	...
	"\x18OAUTH_CLIENT_TYPE_PUBLIC\x10\x022\xd3\x12\n" +
	"\x0fIdentityService\x12K\n" +
	"\aGetUser\x12$.saas.iam.identity.v1.GetUserRequest\x1a\x1a.saas.iam.identity.v1.User\x12\\\n" +
	"\tListUsers\x12&.saas.iam.identity.v1.ListUsersRequest\x1a'.saas.iam.identity.v1.ListUsersResponse\x12Q\n" +
	"\n" +
	"CreateUser\x12'.saas.iam.identity.v1.CreateUserRequest\x1a\x1a.saas.iam.identity.v1.User\x12Q\n" +
	"\n" +
	"UpdateUser\x12'.saas.iam.identity.v1.UpdateUserRequest\x1a\x1a.saas.iam.identity.v1.User\x12e\n" +
	"\vDisableUser\x12(.saas.iam.identity.v1.DisableUserRequest\x1a,.saas.iam.identity.v1.MutateIdentityResponse\x12Q\n" +
	"\tGetTenant\x12&.saas.iam.identity.v1.GetTenantRequest\x1a\x1c.saas.iam.identity.v1.Tenant\x12b\n" +
	"\vListTenants\x12(.saas.iam.identity.v1.ListTenantsRequest\x1a).saas.iam.identity.v1.ListTenantsResponse\x12W\n" +
	"\fCreateTenant\x12).saas.iam.identity.v1.CreateTenantRequest\x1a\x1c.saas.iam.identity.v1.Tenant\x12W\n" +
	"\fUpdateTenant\x12).saas.iam.identity.v1.UpdateTenantRequest\x1a\x1c.saas.iam.identity.v1.Tenant\x12n\n" +
	"\x0fListMemberships\x12,.saas.iam.identity.v1.ListMembershipsRequest\x1a-.saas.iam.identity.v1.ListMembershipsResponse\x12c\n" +
	"\x10CreateMembership\x12-.saas.iam.identity.v1.CreateMembershipRequest\x1a .saas.iam.identity.v1.Membership\x12o\n" +
	"\x10DeleteMembership\x12-.saas.iam.identity.v1.DeleteMembershipRequest\x1a,.saas.iam.identity.v1.MutateIdentityResponse\x12N\n" +
	"\bGetGroup\x12%.saas.iam.identity.v1.GetGroupRequest\x1a\x1b.saas.iam.identity.v1.Group\x12_\n" +
	"\n" +
	"ListGroups\x12'.saas.iam.identity.v1.ListGroupsRequest\x1a(.saas.iam.identity.v1.ListGroupsResponse\x12T\n" +
	"\vCreateGroup\x12(.saas.iam.identity.v1.CreateGroupRequest\x1a\x1b.saas.iam.identity.v1.Group\x12T\n" +
	"\vUpdateGroup\x12(.saas.iam.identity.v1.UpdateGroupRequest\x1a\x1b.saas.iam.identity.v1.Group\x12e\n" +
	"\vDeleteGroup\x12(.saas.iam.identity.v1.DeleteGroupRequest\x1a,.saas.iam.identity.v1.MutateIdentityResponse\x12`\n" +
	"\x0eAddGroupMember\x12+.saas.iam.identity.v1.AddGroupMemberRequest\x1a!.saas.iam.identity.v1.GroupMember\x12q\n" +
	"\x11RemoveGroupMember\x12..saas.iam.identity.v1.RemoveGroupMemberRequest\x1a,.saas.iam.identity.v1.MutateIdentityResponse\x12i\n" +
	"\x11GetServiceAccount\x12..saas.iam.identity.v1.GetServiceAccountRequest\x1a$.saas.iam.identity.v1.ServiceAccount\x12z\n" +
	"\x13ListServiceAccounts\x120.saas.iam.identity.v1.ListServiceAccountsRequest\x1a1.saas.iam.identity.v1.ListServiceAccountsResponse\x12o\n" +
	"\x14CreateServiceAccount\x121.saas.iam.identity.v1.CreateServiceAccountRequest\x1a$.saas.iam.identity.v1.ServiceAccount\x12o\n" +
	"\x14UpdateServiceAccount\x121.saas.iam.identity.v1.UpdateServiceAccountRequest\x1a$.saas.iam.identity.v1.ServiceAccount\x12w\n" +
	"\x14DeleteServiceAccount\x121.saas.iam.identity.v1.DeleteServiceAccountRequest\x1a,.saas.iam.identity.v1.MutateIdentityResponse2\xa5\x05\n" +
	"\x12OAuthFacadeService\x12`\n" +
	"\x0eGetOAuthClient\x12+.saas.iam.identity.v1.GetOAuthClientRequest\x1a!.saas.iam.identity.v1.OAuthClient\x12q\n" +
	"\x10ListOAuthClients\x12-.saas.iam.identity.v1.ListOAuthClientsRequest\x1a..saas.iam.identity.v1.ListOAuthClientsResponse\x12f\n" +
	"\x11CreateOAuthClient\x12..saas.iam.identity.v1.CreateOAuthClientRequest\x1a!.saas.iam.identity.v1.OAuthClient\x12f\n" +
	"\x11UpdateOAuthClient\x12..saas.iam.identity.v1.UpdateOAuthClientRequest\x1a!.saas.iam.identity.v1.OAuthClient\x12q\n" +
	"\x11DeleteOAuthClient\x12..saas.iam.identity.v1.DeleteOAuthClientRequest\x1a,.saas.iam.identity.v1.MutateIdentityResponse\x12w\n" +
	"\x12RotateClientSecret\x12/.saas.iam.identity.v1.RotateClientSecretRequest\x1a0.saas.iam.identity.v1.RotateClientSecretResponseBNZLgithub.com/m8platform/platform/iam/gen/proto/saas/iam/identity/v1;identityv1b\x06proto3"
