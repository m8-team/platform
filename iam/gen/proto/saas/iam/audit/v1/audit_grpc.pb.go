...
const (
	AuditService_ListAuditEvents_FullMethodName = "/saas.iam.audit.v1.AuditService/ListAuditEvents"
	AuditService_GetAuditEvent_FullMethodName   = "/saas.iam.audit.v1.AuditService/GetAuditEvent"
)
...
//
// AuditService exposes read-only access to audit history.
type AuditServiceClient interface {
	...
	// GetAuditEvent returns one audit event by identifier.
...
var AuditService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "saas.iam.audit.v1.AuditService",
	...
	Metadata: "saas/iam/audit/v1/audit.proto",
}
