...
func NewServer(logger *zap.Logger, useCase *tenantuc.SupportAccessUseCase) *Server {
	return &Server{
		logger:  logger,
		useCase: useCase,
	}
...
func (s *Server) GrantTemporaryAccess(ctx context.Context, req *supportv1.GrantTemporaryAccessRequest) (*supportv1.SupportGrant, error) {
...
func (s *Server) ApproveTemporaryAccess(ctx context.Context, req *supportv1.ApproveTemporaryAccessRequest) (*supportv1.SupportGrant, error) {
...
func (s *Server) RevokeTemporaryAccess(ctx context.Context, req *supportv1.RevokeTemporaryAccessRequest) (*supportv1.SupportGrant, error) {
...
func (s *Server) ListSupportGrants(ctx context.Context, req *supportv1.ListSupportGrantsRequest) (*supportv1.ListSupportGrantsResponse, error) {
