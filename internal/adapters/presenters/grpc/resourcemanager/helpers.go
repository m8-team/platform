...
func mapOrganization(value boundaries.Organization) *resourcemanagerv1.Organization {
...
func mapWorkspace(value boundaries.Workspace) *resourcemanagerv1.Workspace {
...
func mapProject(value boundaries.Project) *resourcemanagerv1.Project {
