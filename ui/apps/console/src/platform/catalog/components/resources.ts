...
export const resourceComponents = {
  ...
  ResourceTable: {description: 'Tabular resource list.', props: z.object({resourceType: z.string().optional(), rows: z.array(z.record(z.string(), z.unknown())).optional(), loading: z.boolean().optional(), rowHrefTemplate: z.string(), columns: z.array(field)})},
  ...
  SectionHeader: {description: 'Section heading.', props: z.object({title: z.string()})},
