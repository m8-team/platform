...
export const resourceComponents = {
  ...
  ResourceTable: {description: 'Tabular resource list with optional UI-owned detail routing.', props: z.object({resourceType: z.string().optional(), rows: z.array(z.record(z.string(), z.unknown())).optional(), loading: z.boolean().optional(), columns: z.array(field), detailPath: z.string().optional()})},
