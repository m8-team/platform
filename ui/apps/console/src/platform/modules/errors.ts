// src/platform/modules/errors.ts
...
export class DuplicateQueryError
  extends ModuleRegistryError
{
  constructor(
    queryId: string,
  ...
  extends ModuleRegistryError
{
  constructor(path: readonly string[]) {
    super(
      `Circular module dependency: ${path.join(' -> ')}`,
    );
...
export class RouteCollisionError
  extends ModuleRegistryError
{
  constructor(
    route: string,
...
export class BasePathCollisionError
  extends ModuleRegistryError
{
  constructor(
    basePath: string,
    ...
    super(
      [
        `Module basePath collision: "${basePath}".`,
        `Used by modules`,
        `"${firstModuleId}" and "${secondModuleId}".`,
      ].join(' '),
    );
