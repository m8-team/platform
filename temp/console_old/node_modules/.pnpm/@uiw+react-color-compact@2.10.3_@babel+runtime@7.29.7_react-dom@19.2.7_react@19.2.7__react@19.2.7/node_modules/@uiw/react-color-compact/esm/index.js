...
var _excluded = ["prefixCls", "className", "style", "onChange", "color", "colors", "rectProps", "rectRender", "addonBefore", "addonAfter"];
...
var Compact = /*#__PURE__*/React.forwardRef((props, ref) => {
  ...
  var handleChangeCallback = useCallback(hsv => onChange && onChange(handleColor(hsv)), [onChange]);
