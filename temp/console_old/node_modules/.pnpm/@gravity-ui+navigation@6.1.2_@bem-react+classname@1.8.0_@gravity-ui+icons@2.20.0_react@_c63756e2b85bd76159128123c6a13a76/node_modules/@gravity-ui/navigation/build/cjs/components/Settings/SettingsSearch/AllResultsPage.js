...
function createAllResultsMenuItem() {
    return {
        id: allSearchResultsId,
        title: index.default('label_all-results'),
        icon: { data: icons.ListUl },
    };
}

exports.getSettingsDescriptionWithAllResultsPage = getSettingsDescriptionWithAllResultsPage;
exports.useAllResultsPage = useAllResultsPage;
