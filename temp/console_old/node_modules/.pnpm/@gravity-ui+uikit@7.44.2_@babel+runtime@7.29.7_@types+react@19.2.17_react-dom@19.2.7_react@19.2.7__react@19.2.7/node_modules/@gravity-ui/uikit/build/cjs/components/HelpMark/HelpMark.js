...
exports.HelpMark = React.forwardRef(function HelpMark(rawProps, ref) {
    const { children, qa, className, iconSize = 'm', popoverProps, ...restProps } = (0, useDefaultProps_1.useDefaultProps)('HelpMark', rawProps);
