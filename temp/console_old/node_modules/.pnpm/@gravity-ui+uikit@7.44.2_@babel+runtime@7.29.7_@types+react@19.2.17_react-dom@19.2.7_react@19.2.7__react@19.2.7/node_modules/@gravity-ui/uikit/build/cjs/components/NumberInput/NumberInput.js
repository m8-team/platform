...
exports.NumberInput = React.forwardRef(function NumberInput(rawProps, ref) {
    const { endContent, defaultValue: externalDefaultValue, ...props } = (0, useDefaultProps_1.useDefaultProps)('NumberInput', rawProps);
