...
export interface ProgressWithValueProps extends ProgressGeneralProps, Partial<ProgressDefaultProps> {
...
export interface ProgressWithStackProps extends ProgressGeneralProps, Partial<ProgressDefaultProps> {
...
export declare function isProgressWithStack(props: ProgressProps): props is ProgressWithStackProps;
export {};
