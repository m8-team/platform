...
const AlertIcon = ({ className, theme, align, view = 'filled', size = constants_1.DEFAULT_ICON_SIZE, }) => {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { className: (0, constants_1.bAlert)('icon-wrapper', { align }, (0, colorText_1.colorText)({ color }, className)), children: (0, jsx_runtime_1.jsx)(Icon_1.Icon, { className: (0, constants_1.bAlert)('icon'), data: iconByTheme[view], size: size }) }));
};
