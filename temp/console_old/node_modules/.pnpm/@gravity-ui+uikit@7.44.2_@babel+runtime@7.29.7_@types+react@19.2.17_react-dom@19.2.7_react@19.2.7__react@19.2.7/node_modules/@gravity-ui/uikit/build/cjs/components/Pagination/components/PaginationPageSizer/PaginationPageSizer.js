...
const PaginationPageSizer = ({ onUpdate, pageSize, size, page, pageSizeOptions, total, className, view, }) => {
    ...
    return ((0, jsx_runtime_1.jsx)(Select_1.Select, { qa: constants_1.PaginationQa.PaginationPageSizer, className: className, size: size, onUpdate: handleUpdate, options: options, value: [String(pageSize)], title: t('label_select_size'), view: view }));
};
