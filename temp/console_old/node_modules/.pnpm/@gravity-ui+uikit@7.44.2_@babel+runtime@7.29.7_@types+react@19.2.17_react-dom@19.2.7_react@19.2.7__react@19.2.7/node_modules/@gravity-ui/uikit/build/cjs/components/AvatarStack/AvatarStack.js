...
const AvatarStackComponent = React.forwardRef((rawProps, ref) => {
    const { max = constants_1.AVATAR_STACK_DEFAULT_MAX, total, overlapSize = 's', size, children, className, renderMore, moreVariant, } = (0, useDefaultProps_1.useDefaultProps)('AvatarStack', rawProps);
    const visibleItems = [];
    /** All avatars amount */
