...
function ActionTooltip(rawProps) {
    const { title, description, hotkey, openDelay = DEFAULT_OPEN_DELAY, closeDelay = DEFAULT_CLOSE_DELAY, className, ...restProps } = (0, useDefaultProps_1.useDefaultProps)('ActionTooltip', rawProps);
