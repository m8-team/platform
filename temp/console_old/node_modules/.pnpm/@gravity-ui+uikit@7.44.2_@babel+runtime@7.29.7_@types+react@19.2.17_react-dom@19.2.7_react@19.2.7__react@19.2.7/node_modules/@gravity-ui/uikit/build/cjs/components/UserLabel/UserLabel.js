...
exports.UserLabel = React.forwardRef((rawProps, ref) => {
    const { type = 'person', view = 'outlined', size = constants_1.DEFAULT_USER_LABEL_SIZE, avatar, text, description, onClick, onCloseClick, className, style, qa, } = (0, useDefaultProps_1.useDefaultProps)('UserLabel', rawProps);
