...
import type { InputControlSize } from "../../controls/types.js";
...
export declare function NumericArrows({ className, size, disabled, onUpClick, onDownClick, ...restProps }: NumericArrowsProps): import("react/jsx-runtime").JSX.Element;
export {};
