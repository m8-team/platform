 ...
 * ```
 */
exports.Text = React.forwardRef(function Text(rawProps, ref) {
    const { as, children, variant, className, ellipsis, color, whiteSpace, wordBreak, ellipsisLines, style: outerStyle, qa, ...rest } = (0, useDefaultProps_1.useDefaultProps)('Text', rawProps);
    const Tag = as || 'span';
    const style = {
        ...outerStyle,
    };
