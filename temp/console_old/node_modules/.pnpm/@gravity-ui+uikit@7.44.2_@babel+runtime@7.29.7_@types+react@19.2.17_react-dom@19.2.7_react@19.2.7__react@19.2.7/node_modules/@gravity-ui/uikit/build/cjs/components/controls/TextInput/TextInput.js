...
const Alert_1 = require("../../Alert/index.js");
...
exports.TextInput = React.forwardRef(function TextInput(rawProps, ref) {
    const props = (0, useDefaultProps_1.useDefaultProps)('TextInput', rawProps);
    ...
    return ((0, jsx_runtime_1.jsxs)("span", { ref: ref, style: style, className: b({
            ...
            'has-end-content': isEndContentVisible,
                        ...
                        }, className: b('label'), title: label, htmlFor: id, children: `${label}` })), (0, jsx_runtime_1.jsx)(TextInputControl_1.TextInputControl, { ...props, ...commonProps, controlRef: handleRef }), isClearControlVisible && ((0, jsx_runtime_1.jsx)(common_1.ClearButton, { size: (0, common_1.mapTextInputSizeToButtonSize)(size), onClick: handleClear, className: b('clear', { size }) })), isErrorIconVisible && ((0, jsx_runtime_1.jsx)(Popover_1.Popover, { placement: direction === 'rtl' ? ['left', 'bottom'] : ['right', 'bottom'], className: b('error-popover'), hasArrow: true, content: (0, jsx_runtime_1.jsx)(Alert_1.Alert, { className: b('error-popover-content'), theme: "clear", message: (0, jsx_runtime_1.jsx)("div", { role: "presentation", children: errorMessage }) }), children: (0, jsx_runtime_1.jsx)("span", { "data-qa": utils_1.CONTROL_ERROR_ICON_QA, children: (0, jsx_runtime_1.jsx)(Icon_1.Icon, { data: icons_1.TriangleExclamation, className: b('error-icon'), size: size === 's' ? 12 : 16 }) }) })), isEndContentVisible && ((0, jsx_runtime_1.jsx)(AdditionalContent_1.AdditionalContent, { placement: "end", onClick: handleAdditionalContentClick, children: endContent }))] }), (0, jsx_runtime_1.jsx)(OuterAdditionalContent_1.OuterAdditionalContent, { note: note, errorMessage: isErrorMsgVisible ? errorMessage : null, noteId: noteId, errorMessageId: errorMessageId })] }));
});
