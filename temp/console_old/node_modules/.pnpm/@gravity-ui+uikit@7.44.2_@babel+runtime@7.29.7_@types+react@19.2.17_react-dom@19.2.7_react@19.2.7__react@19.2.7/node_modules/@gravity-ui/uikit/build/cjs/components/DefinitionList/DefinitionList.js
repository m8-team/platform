...
function DefinitionList(rawProps) {
    const { responsive, direction = 'horizontal', nameMaxWidth, contentMaxWidth, className, children, qa, ...restProps } = (0, useDefaultProps_1.useDefaultProps)('DefinitionList', rawProps);
