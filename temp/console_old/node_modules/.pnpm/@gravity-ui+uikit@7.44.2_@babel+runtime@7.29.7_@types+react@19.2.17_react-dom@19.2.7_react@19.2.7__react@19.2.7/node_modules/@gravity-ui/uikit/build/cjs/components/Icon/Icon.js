...
exports.Icon = React.forwardRef((rawProps, ref) => {
    const { data, width, height, size, className, style, color, fill = 'currentColor', stroke = 'none', qa, } = (0, useDefaultProps_1.useDefaultProps)('Icon', rawProps);
