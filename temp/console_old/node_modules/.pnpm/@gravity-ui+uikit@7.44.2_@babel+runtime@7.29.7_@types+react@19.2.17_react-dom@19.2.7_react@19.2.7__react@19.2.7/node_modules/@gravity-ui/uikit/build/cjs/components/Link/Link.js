...
exports.Link = React.forwardRef(function Link(rawProps, ref) {
    const { view = 'normal', visitable = false, underline = false, href, children, extraProps, qa, onClickCapture, ...props } = (0, useDefaultProps_1.useDefaultProps)('Link', rawProps);
