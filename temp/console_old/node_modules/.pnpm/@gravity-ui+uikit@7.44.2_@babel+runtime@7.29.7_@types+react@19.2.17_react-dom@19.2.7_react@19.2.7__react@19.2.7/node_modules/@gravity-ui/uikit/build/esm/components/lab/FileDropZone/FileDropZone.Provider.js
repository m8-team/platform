...
import { getSeparatedItems } from "./utils.js";
const FileDropZoneContext = React.createContext(null);
export const FileDropZoneProvider = ({ accept = [], onUpdate, onUpdateAccepted, onUpdateRejected, title, description, buttonText, icon, errorIcon, disabled, errorMessage, validationState, children, multiple, }) => {
