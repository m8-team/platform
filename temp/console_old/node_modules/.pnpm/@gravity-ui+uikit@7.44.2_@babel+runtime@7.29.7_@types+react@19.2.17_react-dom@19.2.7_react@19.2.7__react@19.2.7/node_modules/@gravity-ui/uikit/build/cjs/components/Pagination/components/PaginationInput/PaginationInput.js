...
const PaginationInput = ({ numberOfPages, size, pageSize, onUpdate, className, view, }) => {
    ...
    return ((0, jsx_runtime_1.jsx)(controls_1.TextInput, { className: b({ size }, className), placeholder: t('label_input-placeholder'), size: size, value: value, onUpdate: handleUpdateValue, onBlur: handleBlur, onKeyUp: handleKeyUp, qa: constants_2.PaginationQa.PaginationInput, view: view }));
};
