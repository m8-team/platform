...
const PlaceholderContainer = (rawProps) => {
    const { direction = 'row', align = 'center', size = 'l', className, title, description, image, content, actions, maxWidth, qa, } = (0, useDefaultProps_1.useDefaultProps)('PlaceholderContainer', rawProps);
    const renderTitle = () => {
        if (!title) {
            return null;
        }
