...
function BreadcrumbsDropdownMenu({ children, disabled, popupPlacement, popupStyle, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: (0, utils_1.b)('menu'), children: [(0, jsx_runtime_1.jsx)(Button_1.Button, { ref: setReference, ...getReferenceProps(), title: t('label_more'), "aria-label": t('label_more'), size: "s", view: "flat", disabled: disabled, children: (0, jsx_runtime_1.jsx)(Button_1.Button.Icon, { children: "..." }) }), (0, jsx_runtime_1.jsx)(Popup_1.Popup, { open: open, floatingContext: context, floatingRef: setFloating, floatingInteractions: interactions, placement: popupPlacement, className: (0, utils_1.b)('menu-popup'), children: (0, jsx_runtime_1.jsx)(menuContext.Provider, { value: { isMenu: true, getItemProps, listItemsRef, activeIndex, popupStyle }, children: children }) })] }));
}
