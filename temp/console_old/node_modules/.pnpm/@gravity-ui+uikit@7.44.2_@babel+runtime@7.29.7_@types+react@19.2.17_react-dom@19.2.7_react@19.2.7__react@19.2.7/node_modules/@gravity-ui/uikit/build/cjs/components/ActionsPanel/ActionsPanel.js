...
const ActionsPanel = (rawProps) => {
    const { className, actions, onClose, renderNote, noteClassName, qa, maxRowActions } = (0, useDefaultProps_1.useDefaultProps)('ActionsPanel', rawProps);
