...
exports.Menu = React.forwardRef(function Menu(rawProps, ref) {
    const { size = 'm', children, style, className, qa, ...restProps } = (0, useDefaultProps_1.useDefaultProps)('Menu', rawProps);
