...
require("./Sheet.css");
const Sheet = (rawProps) => {
    const { children, onClose, visible, id, title, className, contentClassName, swipeAreaClassName, allowHideOnContentScroll, hideTopBar, maxContentHeightCoefficient, alwaysFullHeight, container, disablePortal, qa, } = (0, useDefaultProps_1.useDefaultProps)('Sheet', rawProps);
