...
function DialogFooter(props) {
    ...
    const { mobile, initialFocusRef, initialFocusAction, onTooltipEscapeKeyDown } = React.useContext(DialogPrivateContext_1.DialogPrivateContext);
    ...
    const buttonCancel = ((0, jsx_runtime_1.jsx)("div", { className: b('button', { action: 'cancel' }), children: (0, jsx_runtime_1.jsx)(Button_1.Button, { ref: cancelBtnRef, view: textButtonApply ? 'flat' : 'normal', size: mobile ? 'xl' : 'l', width: "max", onClick: onClickButtonCancel, disabled: loading, ...propsButtonCancel, children: textButtonCancel }) }));
    ...
    const buttons = (() => {
        ...
        return ((0, jsx_runtime_1.jsxs)(React.Fragment, { children: [textButtonCancel && buttonCancel, textButtonApply && buttonApply] }));
    })();
    if (!buttons && !children) {
        return null;
    }
    return ((0, jsx_runtime_1.jsxs)("div", { className: b({ mobile }, className), children: [children && (0, jsx_runtime_1.jsx)("div", { className: b('children'), children: children }), buttons && (0, jsx_runtime_1.jsx)("div", { className: b('bts-wrapper'), children: buttons })] }));
}
