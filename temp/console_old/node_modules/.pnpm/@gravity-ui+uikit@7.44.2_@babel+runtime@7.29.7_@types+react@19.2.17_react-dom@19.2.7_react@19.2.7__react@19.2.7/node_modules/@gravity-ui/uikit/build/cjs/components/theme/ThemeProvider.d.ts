...
import type { ComponentDefaultPropsMap } from "./PrivateDefaultPropsProvider.js";
...
export declare function ThemeProvider({ theme: themeProp, systemLightTheme: systemLightThemeProp, systemDarkTheme: systemDarkThemeProp, direction: directionProp, scoped: scopedProp, rootClassName, children, layout, lang, fallbackLang, defaultProps, }: ThemeProviderProps): import("react/jsx-runtime").JSX.Element;
