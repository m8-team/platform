...
import type { AvatarSize } from "../Avatar/index.js";
...
export type AvatarStackMoreProps = Pick<React.HTMLProps<HTMLDivElement>, 'className' | 'aria-label'> & {
    count: number;
    size?: AvatarSize;
    borderColor?: string;
    variant?: AvatarStackMoreVariant;
};
export type AvatarStackMoreButtonProps = Pick<React.HTMLProps<HTMLButtonElement>, 'onClick'> & AvatarStackMoreProps & {
