...
export declare function normalizeDurationUnit(component: string): "years" | "months" | "days" | "hours" | "minutes" | "seconds" | "milliseconds" | "quarters" | "weeks";
export declare function normalizeComponent(component: string): "year" | "month" | "day" | "hour" | "minute" | "second" | "millisecond" | "quarter" | "date" | "weekNumber" | "isoWeekNumber" | "isoWeekday" | "weekday" | "dayOfYear" | "weekYear" | "isoWeekYear";
...
export declare function gregorianToOrdinal(gregData: {
    year: number;
    month: number;
    date: number;
}): {
