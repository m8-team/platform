...
- Дата: `2026-09-19`.
- Статус: `Proposed`.
- Подтверждение согласования: отсутствует; выбор YDB предлагается к утверждению.
...
Предлагается использовать **YDB** как основную операционную СУБД M8 Platform.
...
До перевода ADR в `Accepted` необходимо выполнить минимальный технический PoC:
