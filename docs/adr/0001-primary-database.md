...
Платформе требуется основная транзакционная СУБД для состояния backend-модулей: организаций, workspace, проектов, идентичностей и других принадлежащих модулям сущностей.
