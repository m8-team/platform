---
title: "ADR-0006: Keycloak CIBA"
description: "Keycloak как поставщик протокольной аутентификации и CIBA."
keywords:
  - "M8 Platform"
  - "ADR"
---

# ADR-0006. Keycloak как поставщик протокольной аутентификации и CIBA {#adr-0006}
...
Использовать Keycloak за ACL; предметная модель AuthenticationTransaction не зависит от внутренних типов Keycloak.
...
- Контракт и реализация ссылаются на `ADR-0006`.
