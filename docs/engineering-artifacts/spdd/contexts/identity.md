---
title: "SP-CONTEXT-ID-001. Context Prompt: Identity"
description: "SPDD context prompt: SP-CONTEXT-ID-001. Context Prompt: Identity."
keywords:
  - "M8 Platform"
  - "SPDD"
---

# SP-CONTEXT-ID-001. Context Prompt: Identity {#identity}
...
```yaml
prompt_id: SP-CONTEXT-ID-001
kind: context
context: Identity
service: m8-identity
requirements_namespace: ID-*
normative_sources:
  - PADS-000@1.0
  - M8-REQ-000@0.1
...
Реализовывать только ответственность контекста **Identity**, сохраняя его ubiquitous language, инварианты, ownership и публичные контракты.
