...
# 16. Длительные операции {#pads-operations}

{% note info "Навигация PADS" %}

[Оглавление PADS](../index.md) | [Предыдущий раздел: 15. Архитектура безопасности](15-security.md) | [Следующий раздел: 17. Модель ошибок](17-errors.md)
