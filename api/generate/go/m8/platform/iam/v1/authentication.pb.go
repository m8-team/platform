...
type Authentication struct {
	...
	// Deprecated. Servers must omit this request-only identifier from all snapshots.
	// Use public_subject for a masked presentation of the claimant.
	//
	...
	PublicSubject           *AuthenticationPublicSubject     `protobuf:"bytes,17,opt,name=public_subject,json=publicSubject,proto3" json:"public_subject,omitempty"`
...
func (x *Authentication) GetPublicSubject() *AuthenticationPublicSubject {
	if x != nil {
		return x.PublicSubject
	}
	return nil
}
...
const file_m8_platform_iam_v1_authentication_proto_rawDesc = "" +
	"\n" +
	"'m8/platform/iam/v1/authentication.proto\x12\x12m8.platform.iam.v1\x1a\x1bbuf/validate/validate.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a/m8/platform/common/extension/v1/extension.proto\x1a1m8/platform/iam/v1/authentication_challenge.proto\x1a.m8/platform/iam/v1/authentication_common.proto\x1a/m8/platform/iam/v1/authentication_context.proto\x1a-m8/platform/iam/v1/authentication_error.proto\x1a/m8/platform/iam/v1/authentication_subject.proto\"\xba\v\n" +
	"\x0eAuthentication\x12\x1e\n" +
	"\x02id\x18\x01 \x01(\tB\x0e\xe0A\b\xe0A\x03\xbaH\x05r\x03\xb0\x01\x01R\x02id\x12+\n" +
	"\tclient_id\x18\x02 \x01(\tB\x0e\xe0A\x03\xe0A\x05\xbaH\x05r\x03\xb0\x01\x01R\bclientId\x12J\n" +
	"\asubject\x18\x03 \x01(\v2).m8.platform.iam.v1.AuthenticationSubjectB\x05\xe0A\x03\x18\x01R\asubject\x12P\n" +
	...
	"\xe0A\x03\xbaH\x04\"\x02(\x00R\aversion\x12[\n" +
	"\x0epublic_subject\x18\x11 \x01(\v2/.m8.platform.iam.v1.AuthenticationPublicSubjectB\x03\xe0A\x03R\rpublicSubject:\x9d\x01\xbaHt\x1ar\n" +
	"!authentication.subject_not_public\x129raw subject identifiers must not be returned in snapshots\x1a\x12!has(this.subject)\x8a\xb5\x18\"m8.platform.iam.authentications.v1\"\xd3\x01\n" +
...
var file_m8_platform_iam_v1_authentication_proto_goTypes = []any{
	...
	(*AuthenticationPublicSubject)(nil),   // 15: m8.platform.iam.v1.AuthenticationPublicSubject
	(AuthenticationMethod)(0),             // 16: m8.platform.iam.v1.AuthenticationMethod
}
var file_m8_platform_iam_v1_authentication_proto_depIdxs = []int32{
	...
	15, // 13: m8.platform.iam.v1.Authentication.public_subject:type_name -> m8.platform.iam.v1.AuthenticationPublicSubject
	13, // 14: m8.platform.iam.v1.AuthenticationInteraction.expire_time:type_name -> google.protobuf.Timestamp
	13, // 15: m8.platform.iam.v1.AuthenticationResult.auth_time:type_name -> google.protobuf.Timestamp
	14, // 16: m8.platform.iam.v1.AuthenticationResult.achieved_assurance_level:type_name -> m8.platform.iam.v1.AuthenticationAssuranceLevel
	16, // 17: m8.platform.iam.v1.AuthenticationResult.authentication_methods:type_name -> m8.platform.iam.v1.AuthenticationMethod
	4,  // 18: m8.platform.iam.v1.AuthenticationResult.handoff:type_name -> m8.platform.iam.v1.AuthenticationHandoff
	0,  // 19: m8.platform.iam.v1.AuthenticationHandoff.type:type_name -> m8.platform.iam.v1.AuthenticationHandoff.Type
	13, // 20: m8.platform.iam.v1.AuthenticationHandoff.expire_time:type_name -> google.protobuf.Timestamp
