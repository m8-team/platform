...
type Organization struct {
	...
	State Organization_State `protobuf:"varint,2,opt,name=state,proto3,enum=m8.platform.resourcemanager.v1.Organization_State" json:"state,omitempty"`
...
func (x *OrganizationInput) Reset() {
	*x = OrganizationInput{}
	mi := &file_m8_platform_resourcemanager_v1_organization_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *OrganizationInput) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OrganizationInput) ProtoMessage() {}

func (x *OrganizationInput) ProtoReflect() protoreflect.Message {
	mi := &file_m8_platform_resourcemanager_v1_organization_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OrganizationInput.ProtoReflect.Descriptor instead.
func (*OrganizationInput) Descriptor() ([]byte, []int) {
	return file_m8_platform_resourcemanager_v1_organization_proto_rawDescGZIP(), []int{1}
}

func (x *OrganizationInput) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *OrganizationInput) GetDescription() string {
	if x != nil {
		return x.Description
	}
	return ""
...
func (x *OrganizationInput) GetLabels() map[string]string {
	if x != nil {
		return x.Labels
	}
	return nil
...
const file_m8_platform_resourcemanager_v1_organization_proto_rawDesc = "" +
	"\n" +
	"1m8/platform/resourcemanager/v1/organization.proto\x12\x1em8.platform.resourcemanager.v1\x1a\x1bbuf/validate/validate.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a/m8/platform/common/extension/v1/extension.proto\"\xcf\x06\n" +
	...
	"\x04name\x18\x03 \x01(\tB\v\xe0A\x01\xbaH\x05r\x03\x18\x80\x02R\x04name\x12-\n" +
	...
	"\xe0A\x01\xbaH\x04\"\x02(\x00R\aversion\x12m\n" +
	"\x06labels\x18\n" +
	" \x03(\v28.m8.platform.resourcemanager.v1.Organization.LabelsEntryB\x1b\xe0A\x01\xbaH\x15\x9a\x01\x12\x10@\"\ar\x05\x10\x01\x18\x80\x01*\x05r\x03\x18\x80\x02R\x06labels\x1a9\n" +
	...
	"\n" +
	"\x06FAILED\x10\x06:0\x8a\xb5\x18,m8.platform.resourcemanager.organizations.v1\"\x89\x02\n" +
	"\x11OrganizationInput\x12\x1c\n" +
	...
	"\x06labels\x18\x03 \x03(\v2=.m8.platform.resourcemanager.v1.OrganizationInput.LabelsEntryB\x18\xbaH\x15\x9a\x01\x12\x10@\"\ar\x05\x10\x01\x18\x80\x01*\x05r\x03\x18\x80\x02R\x06labels\x1a9\n" +
	"\vLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
...
var file_m8_platform_resourcemanager_v1_organization_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_m8_platform_resourcemanager_v1_organization_proto_goTypes = []any{
	...
	(*OrganizationInput)(nil),     // 2: m8.platform.resourcemanager.v1.OrganizationInput
	nil,                           // 3: m8.platform.resourcemanager.v1.Organization.LabelsEntry
	nil,                           // 4: m8.platform.resourcemanager.v1.OrganizationInput.LabelsEntry
...
var file_m8_platform_resourcemanager_v1_organization_proto_depIdxs = []int32{
	...
	5, // 1: m8.platform.resourcemanager.v1.Organization.create_time:type_name -> google.protobuf.Timestamp
	5, // 2: m8.platform.resourcemanager.v1.Organization.update_time:type_name -> google.protobuf.Timestamp
	5, // 3: m8.platform.resourcemanager.v1.Organization.delete_time:type_name -> google.protobuf.Timestamp
	5, // 4: m8.platform.resourcemanager.v1.Organization.purge_time:type_name -> google.protobuf.Timestamp
	3, // 5: m8.platform.resourcemanager.v1.Organization.labels:type_name -> m8.platform.resourcemanager.v1.Organization.LabelsEntry
	4, // 6: m8.platform.resourcemanager.v1.OrganizationInput.labels:type_name -> m8.platform.resourcemanager.v1.OrganizationInput.LabelsEntry
